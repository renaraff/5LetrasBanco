...
namespace _5LetrasBanco.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MateriasNome")] Materias materias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MateriasNome")] Materias materias)
        {
            if (id != materias.Id)
            {
                return NotFound();
