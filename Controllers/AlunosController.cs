...
namespace _5LetrasBanco.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AlunoNome,AlunoEmail,AlunoSenha,AlunoEscolaridade")] Alunos alunos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AlunoNome,AlunoEmail,AlunoSenha,AlunoEscolaridade")] Alunos alunos)
        {
            if (id != alunos.Id)
            {
                return NotFound();
